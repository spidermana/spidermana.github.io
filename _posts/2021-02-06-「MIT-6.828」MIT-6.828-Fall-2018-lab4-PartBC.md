...
使用 user/ping 和 user/primes程序来测试IPC实现的正确性。User/primes 将为每个素数生成一个新环境，直到 JOS 用完所有环境。You might find it interesting to read `user/primes.c` to see all the forking and IPC going on behind the scenes.

## Ending PartC and Lab4

第三部分结束。Make sure you pass all of the make grade tests.

![image-20210219163921189](/img/assets/img/image-20210219163921189.png)
