...
需要使用者进行的**工作主要集中在leak函数的具体实现**上，上面的代码只是个模板。其中，*address*就是<u>leak函数要泄漏信息的所在地址</u>，而*payload*就是<u>触发目标程序泄漏address处信息的攻击代码</u>。
...
![cyclic模块](/img/assets/img/cyclic.jpg)
...
![3pop1ret的gadgets](/img/assets/img/3pop1ret.jpg)
...
![泄露libc库](/img/assets/img/log4.jpg)

![泄露后，获取到system地址](/img/assets/img/leaking4.jpg)

![拿到flag](/img/assets/img/ans4.jpg)
...
<div id="Mark1"></div>
![64位机器下参数传递情况](/img/assets/img/machine64.jpg)
