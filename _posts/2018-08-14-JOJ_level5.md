...
![题目要求](/img/assets/img/xmanlevel5.jpg)
...
![mmap函数](/img/assets/img/mmap.jpg)
...
![根据bss设置addr和len参数](/img/assets/img/bss5.jpg)

获取Linux 内存页（基页）大小的命令：

> getconf PAGE_SIZE 

![Linux 页大小](/img/assets/img/page5.jpg)

故payload应该实现mprotect(0x00600000,0x1000,7)


![攻击结果](/img/assets/img/attack5.jpg)
