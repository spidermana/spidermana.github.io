...
![libc.so库文件](/assets/img/libc9.jpg)

用**objdump -d ./level5观察一下__ libc_ csu_ init()这个函数。**

![__ libc_ csu_ init()函数](/assets/img/obj_libc.jpg)
...
![程序运行停止在绿色小箭头处](/assets/img/edbrun.jpg)
...
![设置第一个参数和第二个参数](/assets/img/offset9.jpg)
...
![PLT和GOT表](assets/img/plt_got.jpg)
...
![_dl_runtime_resolve()](assets/img/got.jpg)
